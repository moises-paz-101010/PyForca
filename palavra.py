...
class GerenciadorPalavras:
    arquivo_palavra = "dados/palavra.json"
    ...
    def carregar_palavras(self):
        try:
            with open(self.arquivo_palavra, self.arquivo_modo_acesso[0], encoding=self.encoding) as arquivo:
    ...
    def salvar_palavras(self):
        ...
        try:
            with open(self.arquivo_palavra, self.arquivo_modo_acesso[2], encoding=self.encoding) as arquivo:
